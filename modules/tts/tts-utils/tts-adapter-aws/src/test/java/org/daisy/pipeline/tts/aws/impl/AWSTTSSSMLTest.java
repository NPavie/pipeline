...
public class AWSTTSSSMLTest {
	...
	public void completeSSML() throws URISyntaxException, SaxonApiException, SAXException,
		...
		String expected = "<speak version=\"1.0\"><s>"
		        + "<y/><token>this</token> is text</s><break time=\"250ms\"/><mark name=\""
		        + endingmark + "\"/></speak>";
	...
	public void incompleteSSML() throws URISyntaxException, SaxonApiException, SAXException,
		...
		String expected = "<speak version=\"1.0\"><s>"
		        + "<y/>this is text</s><break time=\"250ms\"/><mark name=\""
		        + endingmark + "\"/></speak>";
