...
Write-Output ((Get-Date).ToString("yyyy-MM-dd'T'HH:mm:ss.fff", $dateFormat) + " : Launching simple ui from command line ")

&"C:\Users\admin\devs\_Perso\pipeline\pipeline2-1.15.4_sad\daisy-pipeline\bin\simpleui.bat" `
   word-to-dtbook `
   --source "C:\Users\admin\devs\_Perso\pipeline\testfiles\Project_Hail_Mary.docx" `
