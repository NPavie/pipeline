framework/parent/VERSION := 1.15.5-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-parent/1.15.5-SNAPSHOT/framework-parent-1.15.5-SNAPSHOT.pom : framework/parent/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-parent/1.15.5-SNAPSHOT/framework-parent-1.15.5-SNAPSHOT% : framework/parent/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
framework/parent/.compile-dependencies : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-bom/1.15.5-SNAPSHOT/framework-bom-1.15.5-SNAPSHOT.pom
framework/parent/.test-dependencies : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-bom/1.15.5-SNAPSHOT/framework-bom-1.15.5-SNAPSHOT.pom

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-parent/1.15.5/framework-parent-1.15.5.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-parent/1.15.5/framework-parent-1.15.5-% : framework/parent/.release
	+//
...
framework/parent/.release : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-bom/1.15.5/framework-bom-1.15.5.pom
