modules/braille/braille-common/VERSION := 6.0.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/braille/braille-common/modified-since-release_ : modules/braille/braille-common/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/braille-common/6.0.1-SNAPSHOT/braille-common-6.0.1-SNAPSHOT.pom : modules/braille/braille-common/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/braille-common/6.0.1-SNAPSHOT/braille-common-6.0.1-SNAPSHOT% : modules/braille/braille-common/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/braille/braille-common/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/braille/braille-common/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/braille/braille-common/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/braille-common/6.0.1/braille-common-6.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/braille-common/6.0.1/braille-common-6.0.1-% : modules/braille/braille-common/.release
	+//

.SECONDARY : modules/braille/braille-common/.release
modules/braille/braille-common/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("braille/braille-common");

modules/braille/braille-common/.release : \
