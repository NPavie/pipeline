modules/braille/dotify-utils/VERSION := 6.5.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/braille/dotify-utils/modified-since-release_ : modules/braille/dotify-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dotify-utils/6.5.1-SNAPSHOT/dotify-utils-6.5.1-SNAPSHOT.pom : modules/braille/dotify-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dotify-utils/6.5.1-SNAPSHOT/dotify-utils-6.5.1-SNAPSHOT% : modules/braille/dotify-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/braille/dotify-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/braille/dotify-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/braille/dotify-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dotify-utils/6.5.1/dotify-utils-6.5.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dotify-utils/6.5.1/dotify-utils-6.5.1-% : modules/braille/dotify-utils/.release
	+//

.SECONDARY : modules/braille/dotify-utils/.release
modules/braille/dotify-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("braille/dotify-utils");

modules/braille/dotify-utils/.release : \
