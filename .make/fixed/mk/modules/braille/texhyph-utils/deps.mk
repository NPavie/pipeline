modules/braille/texhyph-utils/VERSION := 3.0.6-SNAPSHOT
...
$(TARGET_DIR)/state/modules/braille/texhyph-utils/modified-since-release_ : modules/braille/texhyph-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/texhyph-utils/3.0.6-SNAPSHOT/texhyph-utils-3.0.6-SNAPSHOT.pom : modules/braille/texhyph-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/texhyph-utils/3.0.6-SNAPSHOT/texhyph-utils-3.0.6-SNAPSHOT% : modules/braille/texhyph-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/braille/texhyph-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/braille/texhyph-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/braille/texhyph-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/texhyph-utils/3.0.6/texhyph-utils-3.0.6.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/texhyph-utils/3.0.6/texhyph-utils-3.0.6-% : modules/braille/texhyph-utils/.release
	+//

.SECONDARY : modules/braille/texhyph-utils/.release
modules/braille/texhyph-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("braille/texhyph-utils");

modules/braille/texhyph-utils/.release : \
