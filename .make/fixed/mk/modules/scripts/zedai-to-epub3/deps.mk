modules/scripts/zedai-to-epub3/VERSION := 2.6.2-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-epub3/2.6.2-SNAPSHOT/zedai-to-epub3-2.6.2-SNAPSHOT.pom : modules/scripts/zedai-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-epub3/2.6.2-SNAPSHOT/zedai-to-epub3-2.6.2-SNAPSHOT% : modules/scripts/zedai-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-epub3/2.6.2/zedai-to-epub3-2.6.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-epub3/2.6.2/zedai-to-epub3-2.6.2-% : modules/scripts/zedai-to-epub3/.release
	+//
