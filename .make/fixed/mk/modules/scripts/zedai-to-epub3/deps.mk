modules/scripts/zedai-to-epub3/VERSION := 2.7.0
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-epub3/2.7.0/zedai-to-epub3-2.7.0.pom : modules/scripts/zedai-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-epub3/2.7.0/zedai-to-epub3-2.7.0% : modules/scripts/zedai-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/zedai-to-epub3/.install.pom : %/.install.pom : | %/.compile-dependencies %/.test-dependencies
...
modules/scripts/zedai-to-epub3/.install : %/.install : | %/.compile-dependencies %/.test-dependencies
...
modules/scripts/zedai-to-epub3/.install-doc : %/.install-doc : | %/.compile-dependencies %/.test-dependencies
