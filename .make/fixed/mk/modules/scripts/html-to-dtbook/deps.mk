modules/scripts/html-to-dtbook/VERSION := 2.0.10-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-dtbook/2.0.10-SNAPSHOT/html-to-dtbook-2.0.10-SNAPSHOT.pom : modules/scripts/html-to-dtbook/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-dtbook/2.0.10-SNAPSHOT/html-to-dtbook-2.0.10-SNAPSHOT% : modules/scripts/html-to-dtbook/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-dtbook/2.0.10/html-to-dtbook-2.0.10.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-dtbook/2.0.10/html-to-dtbook-2.0.10-% : modules/scripts/html-to-dtbook/.release
	+//
