modules/scripts/dtbook-to-rtf/VERSION := 2.0.14-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-rtf/2.0.14-SNAPSHOT/dtbook-to-rtf-2.0.14-SNAPSHOT.pom : modules/scripts/dtbook-to-rtf/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-rtf/2.0.14-SNAPSHOT/dtbook-to-rtf-2.0.14-SNAPSHOT% : modules/scripts/dtbook-to-rtf/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-rtf/2.0.14/dtbook-to-rtf-2.0.14.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-rtf/2.0.14/dtbook-to-rtf-2.0.14-% : modules/scripts/dtbook-to-rtf/.release
	+//
