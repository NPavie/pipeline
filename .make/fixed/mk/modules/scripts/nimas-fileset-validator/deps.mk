modules/scripts/nimas-fileset-validator/VERSION := 2.1.7-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/nimas-fileset-validator/2.1.7-SNAPSHOT/nimas-fileset-validator-2.1.7-SNAPSHOT.pom : modules/scripts/nimas-fileset-validator/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/nimas-fileset-validator/2.1.7-SNAPSHOT/nimas-fileset-validator-2.1.7-SNAPSHOT% : modules/scripts/nimas-fileset-validator/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/nimas-fileset-validator/2.1.7/nimas-fileset-validator-2.1.7.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/nimas-fileset-validator/2.1.7/nimas-fileset-validator-2.1.7-% : modules/scripts/nimas-fileset-validator/.release
	+//
