modules/scripts/epub3-to-daisy202/VERSION := 2.2.11-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/epub3-to-daisy202/modified-since-release_ : modules/scripts/epub3-to-daisy202/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-daisy202/2.2.11-SNAPSHOT/epub3-to-daisy202-2.2.11-SNAPSHOT.pom : modules/scripts/epub3-to-daisy202/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-daisy202/2.2.11-SNAPSHOT/epub3-to-daisy202-2.2.11-SNAPSHOT% : modules/scripts/epub3-to-daisy202/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/epub3-to-daisy202/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/epub3-to-daisy202/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/epub3-to-daisy202/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-daisy202/2.2.11/epub3-to-daisy202-2.2.11.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-daisy202/2.2.11/epub3-to-daisy202-2.2.11-% : modules/scripts/epub3-to-daisy202/.release
	+//

.SECONDARY : modules/scripts/epub3-to-daisy202/.release
modules/scripts/epub3-to-daisy202/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/epub3-to-daisy202");

modules/scripts/epub3-to-daisy202/.release : \
