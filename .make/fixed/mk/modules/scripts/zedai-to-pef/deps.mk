modules/scripts/zedai-to-pef/VERSION := 7.0.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/zedai-to-pef/modified-since-release_ : modules/scripts/zedai-to-pef/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.0.1-SNAPSHOT/zedai-to-pef-7.0.1-SNAPSHOT.pom : modules/scripts/zedai-to-pef/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.0.1-SNAPSHOT/zedai-to-pef-7.0.1-SNAPSHOT% : modules/scripts/zedai-to-pef/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/zedai-to-pef/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/zedai-to-pef/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/zedai-to-pef/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.0.1/zedai-to-pef-7.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.0.1/zedai-to-pef-7.0.1-% : modules/scripts/zedai-to-pef/.release
	+//

.SECONDARY : modules/scripts/zedai-to-pef/.release
modules/scripts/zedai-to-pef/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/zedai-to-pef");

modules/scripts/zedai-to-pef/.release : \
