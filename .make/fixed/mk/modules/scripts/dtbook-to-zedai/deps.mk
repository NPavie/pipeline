modules/scripts/dtbook-to-zedai/VERSION := 4.1.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/dtbook-to-zedai/modified-since-release_ : modules/scripts/dtbook-to-zedai/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-zedai/4.1.2-SNAPSHOT/dtbook-to-zedai-4.1.2-SNAPSHOT.pom : modules/scripts/dtbook-to-zedai/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-zedai/4.1.2-SNAPSHOT/dtbook-to-zedai-4.1.2-SNAPSHOT% : modules/scripts/dtbook-to-zedai/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/dtbook-to-zedai/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/dtbook-to-zedai/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/dtbook-to-zedai/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-zedai/4.1.2/dtbook-to-zedai-4.1.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-zedai/4.1.2/dtbook-to-zedai-4.1.2-% : modules/scripts/dtbook-to-zedai/.release
	+//

.SECONDARY : modules/scripts/dtbook-to-zedai/.release
modules/scripts/dtbook-to-zedai/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/dtbook-to-zedai");

modules/scripts/dtbook-to-zedai/.release : \
