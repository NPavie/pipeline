modules/scripts/dtbook-validator/VERSION := 3.0.13-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/dtbook-validator/modified-since-release_ : modules/scripts/dtbook-validator/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.0.13-SNAPSHOT/dtbook-validator-3.0.13-SNAPSHOT.pom : modules/scripts/dtbook-validator/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.0.13-SNAPSHOT/dtbook-validator-3.0.13-SNAPSHOT% : modules/scripts/dtbook-validator/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/dtbook-validator/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/dtbook-validator/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/dtbook-validator/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.0.13/dtbook-validator-3.0.13.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.0.13/dtbook-validator-3.0.13-% : modules/scripts/dtbook-validator/.release
	+//

.SECONDARY : modules/scripts/dtbook-validator/.release
modules/scripts/dtbook-validator/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/dtbook-validator");

modules/scripts/dtbook-validator/.release : \
