modules/scripts/daisy202-to-epub3/VERSION := 2.1.5-SNAPSHOT

$(TARGET_DIR)/state/modules/scripts/daisy202-to-epub3/last-tested : $(TARGET_DIR)/state/%/last-tested : %/.test | .group-eval
	+$(EVAL) mkdirs("$(dir $@)"); touch("$@");

# this rule overrides the implicit rule in main.mk
# note that because the modified-since-release_ files created by main.mk, are deleted,
# this rule gets executed at least once
$(TARGET_DIR)/state/modules/scripts/daisy202-to-epub3/modified-since-release_ : modules/scripts/daisy202-to-epub3/pom.xml \
...
.SECONDARY : modules/scripts/daisy202-to-epub3/.test
modules/scripts/daisy202-to-epub3/.test : | .maven-init .group-eval
	+$(EVAL) mvn.test("$(patsubst %/,%,$(dir $@))");

modules/scripts/daisy202-to-epub3/.test : %/.test : %/pom.xml %/.compile-dependencies %/.test-dependencies

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-epub3/2.1.5-SNAPSHOT/daisy202-to-epub3-2.1.5-SNAPSHOT.pom : modules/scripts/daisy202-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-epub3/2.1.5-SNAPSHOT/daisy202-to-epub3-2.1.5-SNAPSHOT% : modules/scripts/daisy202-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

.SECONDARY : modules/scripts/daisy202-to-epub3/.install.pom
modules/scripts/daisy202-to-epub3/.install.pom : | .maven-init .group-eval
	+$(EVAL) mvn.installPom("modules/scripts/daisy202-to-epub3");

modules/scripts/daisy202-to-epub3/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies

.SECONDARY : modules/scripts/daisy202-to-epub3/.install.jar
modules/scripts/daisy202-to-epub3/.install.jar : %/.install.jar : %/.install

.SECONDARY : modules/scripts/daisy202-to-epub3/.install
modules/scripts/daisy202-to-epub3/.install : | .maven-init .group-eval
	+$(EVAL) mvn.install("$(patsubst %/,%,$(dir $@))");

modules/scripts/daisy202-to-epub3/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies

.SECONDARY : modules/scripts/daisy202-to-epub3/.install-doc.jar
modules/scripts/daisy202-to-epub3/.install-doc.jar : %/.install-doc.jar : %/.install-doc

.SECONDARY : modules/scripts/daisy202-to-epub3/.install-xprocdoc.jar
modules/scripts/daisy202-to-epub3/.install-xprocdoc.jar : %/.install-xprocdoc.jar : %/.install-doc

.SECONDARY : modules/scripts/daisy202-to-epub3/.install-doc
modules/scripts/daisy202-to-epub3/.install-doc : | .maven-init .group-eval
	+$(EVAL) mvn.installDoc("$(patsubst %/,%,$(dir $@))");

modules/scripts/daisy202-to-epub3/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies

.SECONDARY : modules/scripts/daisy202-to-epub3/.compile-dependencies modules/scripts/daisy202-to-epub3/.test-dependencies
modules/scripts/daisy202-to-epub3/.compile-dependencies : \
...
modules/scripts/daisy202-to-epub3/.test-dependencies : \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules-registry/5.0.1-SNAPSHOT/modules-registry-5.0.1-SNAPSHOT.jar \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/common-utils/6.4.1-SNAPSHOT/common-utils-6.4.1-SNAPSHOT.jar \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-utils/6.5.1-SNAPSHOT/html-utils-6.5.1-SNAPSHOT.jar \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/saxon-adapter/5.8.1-SNAPSHOT/saxon-adapter-5.8.1-SNAPSHOT.jar \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-epub3/2.1.5/daisy202-to-epub3-2.1.5.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-epub3/2.1.5/daisy202-to-epub3-2.1.5-% : modules/scripts/daisy202-to-epub3/.release
	+//

.SECONDARY : modules/scripts/daisy202-to-epub3/.release
modules/scripts/daisy202-to-epub3/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/daisy202-to-epub3");

modules/scripts/daisy202-to-epub3/.release : \
...
clean : modules/scripts/daisy202-to-epub3/.clean
.PHONY : modules/scripts/daisy202-to-epub3/.clean
modules/scripts/daisy202-to-epub3/.clean :
	rm("modules/scripts/daisy202-to-epub3/target");
