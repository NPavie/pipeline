modules/scripts/epub-to-daisy/VERSION := 1.4.5-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub-to-daisy/1.4.5-SNAPSHOT/epub-to-daisy-1.4.5-SNAPSHOT.pom : modules/scripts/epub-to-daisy/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub-to-daisy/1.4.5-SNAPSHOT/epub-to-daisy-1.4.5-SNAPSHOT% : modules/scripts/epub-to-daisy/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub-to-daisy/1.4.5/epub-to-daisy-1.4.5.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub-to-daisy/1.4.5/epub-to-daisy-1.4.5-% : modules/scripts/epub-to-daisy/.release
	+//
