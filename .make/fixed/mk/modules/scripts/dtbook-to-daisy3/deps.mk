modules/scripts/dtbook-to-daisy3/VERSION := 4.1.0
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-daisy3/4.1.0/dtbook-to-daisy3-4.1.0.pom : modules/scripts/dtbook-to-daisy3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-daisy3/4.1.0/dtbook-to-daisy3-4.1.0% : modules/scripts/dtbook-to-daisy3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/dtbook-to-daisy3/.install.pom : %/.install.pom : | %/.compile-dependencies %/.test-dependencies
...
modules/scripts/dtbook-to-daisy3/.install : %/.install : | %/.compile-dependencies %/.test-dependencies
...
modules/scripts/dtbook-to-daisy3/.install-doc : %/.install-doc : | %/.compile-dependencies %/.test-dependencies
