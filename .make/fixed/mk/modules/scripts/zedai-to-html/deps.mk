modules/scripts/zedai-to-html/VERSION := 2.6.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/zedai-to-html/modified-since-release_ : modules/scripts/zedai-to-html/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-html/2.6.2-SNAPSHOT/zedai-to-html-2.6.2-SNAPSHOT.pom : modules/scripts/zedai-to-html/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-html/2.6.2-SNAPSHOT/zedai-to-html-2.6.2-SNAPSHOT% : modules/scripts/zedai-to-html/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/zedai-to-html/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/zedai-to-html/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/zedai-to-html/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-html/2.6.2/zedai-to-html-2.6.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-to-html/2.6.2/zedai-to-html-2.6.2-% : modules/scripts/zedai-to-html/.release
	+//

.SECONDARY : modules/scripts/zedai-to-html/.release
modules/scripts/zedai-to-html/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/zedai-to-html");

modules/scripts/zedai-to-html/.release : \
