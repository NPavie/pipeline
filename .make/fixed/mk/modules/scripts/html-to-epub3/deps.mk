modules/scripts/html-to-epub3/VERSION := 2.5.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/html-to-epub3/modified-since-release_ : modules/scripts/html-to-epub3/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-epub3/2.5.2-SNAPSHOT/html-to-epub3-2.5.2-SNAPSHOT.pom : modules/scripts/html-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-epub3/2.5.2-SNAPSHOT/html-to-epub3-2.5.2-SNAPSHOT% : modules/scripts/html-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/html-to-epub3/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/html-to-epub3/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/html-to-epub3/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-epub3/2.5.2/html-to-epub3-2.5.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/html-to-epub3/2.5.2/html-to-epub3-2.5.2-% : modules/scripts/html-to-epub3/.release
	+//

.SECONDARY : modules/scripts/html-to-epub3/.release
modules/scripts/html-to-epub3/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/html-to-epub3");

modules/scripts/html-to-epub3/.release : \
