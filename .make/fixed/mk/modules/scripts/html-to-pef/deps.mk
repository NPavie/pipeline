modules/scripts/html-to-pef/VERSION := 9.0.1-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/html-to-pef/9.0.1-SNAPSHOT/html-to-pef-9.0.1-SNAPSHOT.pom : modules/scripts/html-to-pef/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/html-to-pef/9.0.1-SNAPSHOT/html-to-pef-9.0.1-SNAPSHOT% : modules/scripts/html-to-pef/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/html-to-pef/9.0.1/html-to-pef-9.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/html-to-pef/9.0.1/html-to-pef-9.0.1-% : modules/scripts/html-to-pef/.release
	+//
