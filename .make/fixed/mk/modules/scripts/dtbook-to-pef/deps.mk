modules/scripts/dtbook-to-pef/VERSION := 12.0.1-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dtbook-to-pef/12.0.1-SNAPSHOT/dtbook-to-pef-12.0.1-SNAPSHOT.pom : modules/scripts/dtbook-to-pef/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dtbook-to-pef/12.0.1-SNAPSHOT/dtbook-to-pef-12.0.1-SNAPSHOT% : modules/scripts/dtbook-to-pef/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dtbook-to-pef/12.0.1/dtbook-to-pef-12.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/dtbook-to-pef/12.0.1/dtbook-to-pef-12.0.1-% : modules/scripts/dtbook-to-pef/.release
	+//
