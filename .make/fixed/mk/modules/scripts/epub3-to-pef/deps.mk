modules/scripts/epub3-to-pef/VERSION := 9.0.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts/epub3-to-pef/modified-since-release_ : modules/scripts/epub3-to-pef/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/epub3-to-pef/9.0.1-SNAPSHOT/epub3-to-pef-9.0.1-SNAPSHOT.pom : modules/scripts/epub3-to-pef/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/epub3-to-pef/9.0.1-SNAPSHOT/epub3-to-pef-9.0.1-SNAPSHOT% : modules/scripts/epub3-to-pef/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/epub3-to-pef/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/epub3-to-pef/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts/epub3-to-pef/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/epub3-to-pef/9.0.1/epub3-to-pef-9.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/epub3-to-pef/9.0.1/epub3-to-pef-9.0.1-% : modules/scripts/epub3-to-pef/.release
	+//

.SECONDARY : modules/scripts/epub3-to-pef/.release
modules/scripts/epub3-to-pef/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts/epub3-to-pef");

modules/scripts/epub3-to-pef/.release : \
