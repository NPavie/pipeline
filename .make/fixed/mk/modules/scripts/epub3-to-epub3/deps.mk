modules/scripts/epub3-to-epub3/VERSION := 5.0.3-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-epub3/5.0.3-SNAPSHOT/epub3-to-epub3-5.0.3-SNAPSHOT.pom : modules/scripts/epub3-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-epub3/5.0.3-SNAPSHOT/epub3-to-epub3-5.0.3-SNAPSHOT% : modules/scripts/epub3-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-epub3/5.0.3/epub3-to-epub3-5.0.3.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-epub3/5.0.3/epub3-to-epub3-5.0.3-% : modules/scripts/epub3-to-epub3/.release
	+//
