modules/scripts/epub3-to-epub3/VERSION := 5.1.0
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-epub3/5.1.0/epub3-to-epub3-5.1.0.pom : modules/scripts/epub3-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-epub3/5.1.0/epub3-to-epub3-5.1.0% : modules/scripts/epub3-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts/epub3-to-epub3/.install.pom : %/.install.pom : | %/.compile-dependencies %/.test-dependencies
...
modules/scripts/epub3-to-epub3/.install : %/.install : | %/.compile-dependencies %/.test-dependencies
...
modules/scripts/epub3-to-epub3/.install-doc : %/.install-doc : | %/.compile-dependencies %/.test-dependencies
