modules/tts/tts-adapter-espeak/VERSION := 3.0.17-SNAPSHOT
...
$(TARGET_DIR)/state/modules/tts/tts-adapter-espeak/modified-since-release_ : modules/tts/tts-adapter-espeak/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-espeak/3.0.17-SNAPSHOT/tts-adapter-espeak-3.0.17-SNAPSHOT.pom : modules/tts/tts-adapter-espeak/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-espeak/3.0.17-SNAPSHOT/tts-adapter-espeak-3.0.17-SNAPSHOT% : modules/tts/tts-adapter-espeak/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/tts/tts-adapter-espeak/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/tts/tts-adapter-espeak/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/tts/tts-adapter-espeak/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-espeak/3.0.17/tts-adapter-espeak-3.0.17.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-espeak/3.0.17/tts-adapter-espeak-3.0.17-% : modules/tts/tts-adapter-espeak/.release
	+//

.SECONDARY : modules/tts/tts-adapter-espeak/.release
modules/tts/tts-adapter-espeak/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("tts/tts-adapter-espeak");

modules/tts/tts-adapter-espeak/.release : \
