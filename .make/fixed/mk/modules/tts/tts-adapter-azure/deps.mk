modules/tts/tts-adapter-azure/VERSION := 1.1.4-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.4-SNAPSHOT/tts-adapter-azure-1.1.4-SNAPSHOT.pom : modules/tts/tts-adapter-azure/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.4-SNAPSHOT/tts-adapter-azure-1.1.4-SNAPSHOT% : modules/tts/tts-adapter-azure/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.4/tts-adapter-azure-1.1.4.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.4/tts-adapter-azure-1.1.4-% : modules/tts/tts-adapter-azure/.release
	+//
