modules/tts/tts-adapter-cereproc/VERSION := 1.1.9-SNAPSHOT
...
$(TARGET_DIR)/state/modules/tts/tts-adapter-cereproc/modified-since-release_ : modules/tts/tts-adapter-cereproc/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.9-SNAPSHOT/tts-adapter-cereproc-1.1.9-SNAPSHOT.pom : modules/tts/tts-adapter-cereproc/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.9-SNAPSHOT/tts-adapter-cereproc-1.1.9-SNAPSHOT% : modules/tts/tts-adapter-cereproc/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/tts/tts-adapter-cereproc/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/tts/tts-adapter-cereproc/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/tts/tts-adapter-cereproc/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.9/tts-adapter-cereproc-1.1.9.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.9/tts-adapter-cereproc-1.1.9-% : modules/tts/tts-adapter-cereproc/.release
	+//

.SECONDARY : modules/tts/tts-adapter-cereproc/.release
modules/tts/tts-adapter-cereproc/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("tts/tts-adapter-cereproc");

modules/tts/tts-adapter-cereproc/.release : \
