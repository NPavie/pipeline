modules/tts/tts-adapter-sapinative/VERSION := 3.2.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/tts/tts-adapter-sapinative/modified-since-release_ : modules/tts/tts-adapter-sapinative/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-sapinative/3.2.2-SNAPSHOT/tts-adapter-sapinative-3.2.2-SNAPSHOT.pom : modules/tts/tts-adapter-sapinative/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-sapinative/3.2.2-SNAPSHOT/tts-adapter-sapinative-3.2.2-SNAPSHOT% : modules/tts/tts-adapter-sapinative/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/tts/tts-adapter-sapinative/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/tts/tts-adapter-sapinative/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/tts/tts-adapter-sapinative/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-sapinative/3.2.2/tts-adapter-sapinative-3.2.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-sapinative/3.2.2/tts-adapter-sapinative-3.2.2-% : modules/tts/tts-adapter-sapinative/.release
	+//

.SECONDARY : modules/tts/tts-adapter-sapinative/.release
modules/tts/tts-adapter-sapinative/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("tts/tts-adapter-sapinative");

modules/tts/tts-adapter-sapinative/.release : \
