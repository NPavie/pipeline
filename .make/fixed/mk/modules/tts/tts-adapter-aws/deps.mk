modules/tts/tts-adapter-aws/VERSION := 1.0.2-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-aws/1.0.2-SNAPSHOT/tts-adapter-aws-1.0.2-SNAPSHOT.pom : modules/tts/tts-adapter-aws/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-aws/1.0.2-SNAPSHOT/tts-adapter-aws-1.0.2-SNAPSHOT% : modules/tts/tts-adapter-aws/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-aws/1.0.2/tts-adapter-aws-1.0.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-aws/1.0.2/tts-adapter-aws-1.0.2-% : modules/tts/tts-adapter-aws/.release
	+//
