modules/scripts-utils/daisy3-utils/VERSION := 4.2.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts-utils/daisy3-utils/modified-since-release_ : modules/scripts-utils/daisy3-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-utils/4.2.1-SNAPSHOT/daisy3-utils-4.2.1-SNAPSHOT.pom : modules/scripts-utils/daisy3-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-utils/4.2.1-SNAPSHOT/daisy3-utils-4.2.1-SNAPSHOT% : modules/scripts-utils/daisy3-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts-utils/daisy3-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts-utils/daisy3-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts-utils/daisy3-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-utils/4.2.1/daisy3-utils-4.2.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-utils/4.2.1/daisy3-utils-4.2.1-% : modules/scripts-utils/daisy3-utils/.release
	+//

.SECONDARY : modules/scripts-utils/daisy3-utils/.release
modules/scripts-utils/daisy3-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts-utils/daisy3-utils");

modules/scripts-utils/daisy3-utils/.release : \
