modules/scripts-utils/pandoc-adapter/VERSION := 1.0.0-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/pandoc-adapter/1.0.0-SNAPSHOT/pandoc-adapter-1.0.0-SNAPSHOT.pom : modules/scripts-utils/pandoc-adapter/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/pandoc-adapter/1.0.0-SNAPSHOT/pandoc-adapter-1.0.0-SNAPSHOT% : modules/scripts-utils/pandoc-adapter/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/pandoc-adapter/1.0.0/pandoc-adapter-1.0.0.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/pandoc-adapter/1.0.0/pandoc-adapter-1.0.0-% : modules/scripts-utils/pandoc-adapter/.release
	+//
