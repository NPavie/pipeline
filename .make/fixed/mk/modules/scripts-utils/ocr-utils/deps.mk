modules/scripts-utils/ocr-utils/VERSION := 1.0.0-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts-utils/ocr-utils/modified-since-release_ : modules/scripts-utils/ocr-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/ocr-utils/1.0.0-SNAPSHOT/ocr-utils-1.0.0-SNAPSHOT.pom : modules/scripts-utils/ocr-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/ocr-utils/1.0.0-SNAPSHOT/ocr-utils-1.0.0-SNAPSHOT% : modules/scripts-utils/ocr-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts-utils/ocr-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts-utils/ocr-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts-utils/ocr-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/ocr-utils/1.0.0/ocr-utils-1.0.0.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/ocr-utils/1.0.0/ocr-utils-1.0.0-% : modules/scripts-utils/ocr-utils/.release
	+//

.SECONDARY : modules/scripts-utils/ocr-utils/.release
modules/scripts-utils/ocr-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts-utils/ocr-utils");

modules/scripts-utils/ocr-utils/.release : \
