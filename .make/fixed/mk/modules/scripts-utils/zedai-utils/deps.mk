modules/scripts-utils/zedai-utils/VERSION := 1.3.1-SNAPSHOT

$(TARGET_DIR)/state/modules/scripts-utils/zedai-utils/last-tested : $(TARGET_DIR)/state/%/last-tested : %/.test | .group-eval
	+$(EVAL) mkdirs("$(dir $@)"); touch("$@");

# this rule overrides the implicit rule in main.mk
# note that because the modified-since-release_ files created by main.mk, are deleted,
# this rule gets executed at least once
$(TARGET_DIR)/state/modules/scripts-utils/zedai-utils/modified-since-release_ : modules/scripts-utils/zedai-utils/pom.xml \
...
.SECONDARY : modules/scripts-utils/zedai-utils/.test
modules/scripts-utils/zedai-utils/.test : | .maven-init .group-eval
	+$(EVAL) mvn.test("$(patsubst %/,%,$(dir $@))");

modules/scripts-utils/zedai-utils/.test : %/.test : %/pom.xml %/.compile-dependencies %/.test-dependencies

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-utils/1.3.1-SNAPSHOT/zedai-utils-1.3.1-SNAPSHOT.pom : modules/scripts-utils/zedai-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-utils/1.3.1-SNAPSHOT/zedai-utils-1.3.1-SNAPSHOT% : modules/scripts-utils/zedai-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

.SECONDARY : modules/scripts-utils/zedai-utils/.install.pom
modules/scripts-utils/zedai-utils/.install.pom : | .maven-init .group-eval
	+$(EVAL) mvn.installPom("modules/scripts-utils/zedai-utils");

modules/scripts-utils/zedai-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies

.SECONDARY : modules/scripts-utils/zedai-utils/.install.jar
modules/scripts-utils/zedai-utils/.install.jar : %/.install.jar : %/.install

.SECONDARY : modules/scripts-utils/zedai-utils/.install
modules/scripts-utils/zedai-utils/.install : | .maven-init .group-eval
	+$(EVAL) mvn.install("$(patsubst %/,%,$(dir $@))");

modules/scripts-utils/zedai-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies

.SECONDARY : modules/scripts-utils/zedai-utils/.install-doc.jar
modules/scripts-utils/zedai-utils/.install-doc.jar : %/.install-doc.jar : %/.install-doc

.SECONDARY : modules/scripts-utils/zedai-utils/.install-xprocdoc.jar
modules/scripts-utils/zedai-utils/.install-xprocdoc.jar : %/.install-xprocdoc.jar : %/.install-doc

.SECONDARY : modules/scripts-utils/zedai-utils/.install-doc
modules/scripts-utils/zedai-utils/.install-doc : | .maven-init .group-eval
	+$(EVAL) mvn.installDoc("$(patsubst %/,%,$(dir $@))");

modules/scripts-utils/zedai-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies

.SECONDARY : modules/scripts-utils/zedai-utils/.compile-dependencies modules/scripts-utils/zedai-utils/.test-dependencies
modules/scripts-utils/zedai-utils/.compile-dependencies : \
...
modules/scripts-utils/zedai-utils/.test-dependencies : \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules-registry/5.0.1-SNAPSHOT/modules-registry-5.0.1-SNAPSHOT.jar \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/common-utils/6.4.1-SNAPSHOT/common-utils-6.4.1-SNAPSHOT.jar \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/webservice/3.8.1-SNAPSHOT/webservice-3.8.1-SNAPSHOT.jar \
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/framework-core/11.0.1-SNAPSHOT/framework-core-11.0.1-SNAPSHOT.jar \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-utils/1.3.1/zedai-utils-1.3.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/zedai-utils/1.3.1/zedai-utils-1.3.1-% : modules/scripts-utils/zedai-utils/.release
	+//

.SECONDARY : modules/scripts-utils/zedai-utils/.release
modules/scripts-utils/zedai-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts-utils/zedai-utils");

modules/scripts-utils/zedai-utils/.release : \
...
clean : modules/scripts-utils/zedai-utils/.clean
.PHONY : modules/scripts-utils/zedai-utils/.clean
modules/scripts-utils/zedai-utils/.clean :
	rm("modules/scripts-utils/zedai-utils/target");
