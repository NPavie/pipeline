modules/scripts-utils/asciimath-utils/VERSION := 2.0.1-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.1-SNAPSHOT/asciimath-utils-2.0.1-SNAPSHOT.pom : modules/scripts-utils/asciimath-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.1-SNAPSHOT/asciimath-utils-2.0.1-SNAPSHOT% : modules/scripts-utils/asciimath-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.1/asciimath-utils-2.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.1/asciimath-utils-2.0.1-% : modules/scripts-utils/asciimath-utils/.release
	+//
