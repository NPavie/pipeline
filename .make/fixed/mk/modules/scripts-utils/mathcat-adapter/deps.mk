modules/scripts-utils/mathcat-adapter/VERSION := 1.0.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/scripts-utils/mathcat-adapter/modified-since-release_ : modules/scripts-utils/mathcat-adapter/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mathcat-adapter/1.0.1-SNAPSHOT/mathcat-adapter-1.0.1-SNAPSHOT.pom : modules/scripts-utils/mathcat-adapter/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mathcat-adapter/1.0.1-SNAPSHOT/mathcat-adapter-1.0.1-SNAPSHOT% : modules/scripts-utils/mathcat-adapter/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/scripts-utils/mathcat-adapter/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts-utils/mathcat-adapter/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/scripts-utils/mathcat-adapter/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mathcat-adapter/1.0.1/mathcat-adapter-1.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mathcat-adapter/1.0.1/mathcat-adapter-1.0.1-% : modules/scripts-utils/mathcat-adapter/.release
	+//

.SECONDARY : modules/scripts-utils/mathcat-adapter/.release
modules/scripts-utils/mathcat-adapter/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("scripts-utils/mathcat-adapter");

modules/scripts-utils/mathcat-adapter/.release : \
