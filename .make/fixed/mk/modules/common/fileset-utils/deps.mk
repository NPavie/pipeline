modules/common/fileset-utils/VERSION := 7.0.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/common/fileset-utils/modified-since-release_ : modules/common/fileset-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/fileset-utils/7.0.2-SNAPSHOT/fileset-utils-7.0.2-SNAPSHOT.pom : modules/common/fileset-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/fileset-utils/7.0.2-SNAPSHOT/fileset-utils-7.0.2-SNAPSHOT% : modules/common/fileset-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/common/fileset-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/common/fileset-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/common/fileset-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/fileset-utils/7.0.2/fileset-utils-7.0.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/fileset-utils/7.0.2/fileset-utils-7.0.2-% : modules/common/fileset-utils/.release
	+//

.SECONDARY : modules/common/fileset-utils/.release
modules/common/fileset-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("common/fileset-utils");

modules/common/fileset-utils/.release : \
