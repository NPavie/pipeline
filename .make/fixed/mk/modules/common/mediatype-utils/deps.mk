modules/common/mediatype-utils/VERSION := 2.1.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/common/mediatype-utils/modified-since-release_ : modules/common/mediatype-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mediatype-utils/2.1.1-SNAPSHOT/mediatype-utils-2.1.1-SNAPSHOT.pom : modules/common/mediatype-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mediatype-utils/2.1.1-SNAPSHOT/mediatype-utils-2.1.1-SNAPSHOT% : modules/common/mediatype-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/common/mediatype-utils/.install.pom : %/.install.pom : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/common/mediatype-utils/.install : %/.install : %/pom.xml %/.compile-dependencies | %/.test-dependencies
...
modules/common/mediatype-utils/.install-doc : %/.install-doc : %/pom.xml | %/.compile-dependencies %/.test-dependencies
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mediatype-utils/2.1.1/mediatype-utils-2.1.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/mediatype-utils/2.1.1/mediatype-utils-2.1.1-% : modules/common/mediatype-utils/.release
	+//

.SECONDARY : modules/common/mediatype-utils/.release
modules/common/mediatype-utils/.release : modules/.release
	+$(EVAL) mvn.releaseModulesInDir("modules").apply("common/mediatype-utils");

modules/common/mediatype-utils/.release : \
